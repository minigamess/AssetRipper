...
{
	public static Dictionary<UnityGuid, UnityGuid> GuidMap { get; } = new();
	public static Dictionary<PPtrData, PPtrData> PPtrMap { get; } = new();
	...
	public readonly record struct PPtrData(long FileID, UnityGuid Guid)
	{
